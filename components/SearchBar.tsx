          ...
          <div
            className={
              search.length >= 2 && isOpen
                ? "search-results bg-white absolute w-full flex flex-col visible rounded-b-md p-2 border-2 border-t-0 border-purple-700"
                : "search-results bg-white absolute w-full flex flex-col invisible rounded-b-md p-2 border-2 border-t-0 border-purple-700"
            }
          >
